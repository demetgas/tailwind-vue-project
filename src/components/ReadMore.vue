<template>
  ...
  >
    ...
    <div className="flex flex-col text-justify lg:ml-8 mt-20 md:p-0 p-5">
      <p
        className="underline md:text-[20px] text-[17px] font-bold cursor-pointer "
      >
        Check this out
      </p>
      <h1
        className="lg:text-3xl md:text-[25px] text-lg sm:text-2xl mt-2 text-start  "
      >
      ...
      <div className="flex my-5 md:text-[17px] md:pr-3 p-0">
        ...
        />
        <p>
          Their expressive eyes reveal a depth of emotion and intelligence that
      ...
      <button
        className="bg-hero2 hover:bg-hero transition duration-3000 ease-out delay-100 rounded w-32 h-12 text-white font-bold md:mt-8 lg:mt-10 sm:mt-5 mt-5 mx-auto  md:mx-0 lg:mx-0"
      >
        Read More
      </button>
    </div>
    <div className=" mt-12 mx-auto text-center ">
      ...
      <div
        className="grid lg:grid-cols-1 md:grid-cols-3 lg:w-[20svw] md:w-[100svw] w-[60svw] gap-6 mt-6 mx-auto "
      >
        <div

<template>
  ...
  >
    ...
    <div
      className="flex text-justify flex-col lg:mt-0 md:mt-20 lg:p-0 md:p-0 sm:p-5"
    >
      <p
        className="underline lg:text-[20px] md:text-[17px] xs:text-[17px] xs:mt-10 lg:mt-0 md:mt-0 sm:mt-10 font-bold cursor-pointer"
      >
        Check this out
      </p>
    ...
    <div className="  md:mt-12 lg:mt-0 sm:mt-0  xs:mt-14 mx-auto text-center ">
      <h1
        className="lg:text-2xl md:text-[25px] sm:text-xl xs:text-xl font-bold"
      >
